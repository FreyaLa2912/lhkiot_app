      ...
      <Block flex style={styles.group}>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          <Input
            ...
            iconContent={<Icon size={11} color={argonTheme.COLORS.ICON} name="zoom-in" family="IconCollection" />}
          />
        </Block>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          <Input
            ...
            iconContent={
              ...
              >
                <Icon size={11} color={argonTheme.COLORS.ICON} name="checkmark" family="IconCollection" />
              </Block>
            }
          />
        </Block>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          <Input
            ...
            iconContent={
              ...
              >
                <Icon size={11} color={argonTheme.COLORS.ICON} name="phone" family="IconCollection" />
              </Block>
            }
          />
        </Block>
      ...
      <Block flex style={styles.group}>
        ...
        <Block style={{ paddingHorizontal: theme.SIZES.BASE }}>
          <Block row middle space="between" style={{ marginBottom: theme.SIZES.BASE }}>
            ...
            <Switch value={switches['switch-1']} onValueChange={() => toggleSwitch('switch-1')} />
          </Block>
          <Block row middle space="between">
            <Text size={14}>Switch is OFF</Text>
            <Switch value={switches['switch-2']} onValueChange={() => toggleSwitch('switch-2')} />
          </Block>
        </Block>
      </Block>
    );
    ...
    return (
      <Block flex style={styles.group}>
        ...
        <Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header tabs={tabs.categories} search title="Title" navigation={navigation} />
          </Block>

          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header options search title="Title" optionLeft="Option 1" optionRight="Option 2" navigation={navigation} />
          </Block>
        </Block>
      </Block>
    );

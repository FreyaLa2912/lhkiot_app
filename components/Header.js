...
const BellButton = ({ isWhite, style, navigation }) => {
  ...
  return (
    <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Pro')}>
      <Icon family="IconCollection" size={16} name="bell" color={argonTheme.COLORS[isWhite ? 'WHITE' : 'ICON']} />
...
const BasketButton = ({ isWhite, style, navigation }) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Pro')}>
    <Icon family="IconCollection" size={16} name="cart" color={argonTheme.COLORS[isWhite ? 'WHITE' : 'ICON']} />
  </TouchableOpacity>
);
  ...
  const renderSearch = () => {
    return (
      <Input
        ...
        iconContent={<Icon size={16} color={theme.COLORS.MUTED} name="zoom-in" family="IconCollection" />}
      />
    );
  };
    ...
    return (
      <Block row style={styles.options}>
        <Button shadowless style={[styles.tab, styles.divider]} onPress={() => navigation.navigate('Pro')}>
          <Block row middle>
            <Icon name="diamonds" family="IconCollection" style={{ paddingRight: 8 }} color={argonTheme.COLORS.ICON} />

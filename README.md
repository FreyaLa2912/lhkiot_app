...
### CREATE NEW SCREEN (Example Screen)

- search '`EventEmitter.removeListener('${eventType}'...' and comment console.warn func

### CREATE NEW SCREEN (Example Screen)

- In screens folder -create ExampleScreen.js
- export to index.js
- In stacks folder -create Example.js
- export to index.js
